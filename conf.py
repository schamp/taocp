...
BLOG_AUTHOR = "Andrew Schamp"  # (translatable)
BLOG_TITLE = "TAoCP Exercises"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://schamp.github.com/taocp/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://schamp.github.com/taocp/"
BLOG_EMAIL = "hahaha@nicetry.com"
BLOG_DESCRIPTION = "Exercises for the Art of Computer Programming"  # (translatable)
...
# before deploying.
# must set to false if travis is building and deploying for us
